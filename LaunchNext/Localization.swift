    ...
    private init() {
        var builder: [AppLanguage: [LocalizationKey: String]] = [
            .english: [
                ...
                .kioskModeDescription: "Home screen mode. Apps open fullscreen in their own Space — swipe back to return. Enables Classic mode and Auto Fullscreen. Hotkey and Escape still work.",
                .showInDockTitle: "Show in Dock",
                .showInDockDescription: "Show LaunchNext in the Dock and Cmd+Tab switcher.",
        ...
        .portugueseBrazil: [
            ...
            .kioskModeDescription: "Modo tela inicial. Apps abrem em tela cheia no proprio Space — deslize para voltar. Ativa o modo Classico e Tela Cheia Automatica. Atalho e Escape continuam funcionando.",
            .showInDockTitle: "Mostrar no Dock",
            .showInDockDescription: "Exibir LaunchNext no Dock e no alternador Cmd+Tab.",
            ...
            .loadingApplications: "正在加载应用…",
                ...
                .kioskModeDescription: "主屏幕模式。应用在各自的 Space 中全屏打开——滑动返回。自动启用经典模式和自动全屏。快捷键和 Escape 仍可使用。",
                .showInDockTitle: "在 Dock 中显示",
                .showInDockDescription: "在 Dock 和 Cmd+Tab 切换器中显示 LaunchNext。",
            ...
            .loadingApplications: "Caricamento applicazioni…",
                ...
                .kioskModeDescription: "Modalita schermata iniziale. Le app si aprono a schermo intero nel proprio Space — scorri per tornare. Attiva modalita Classica e Schermo intero automatico. Esc e la scorciatoia funzionano ancora.",
                .showInDockTitle: "Mostra nel Dock",
                .showInDockDescription: "Mostra LaunchNext nel Dock e nel selettore Cmd+Tab.",
        ...
        builder[.japanese]?.merge([
            ...
            .kioskModeDescription: "ホーム画面モード。アプリは専用のSpaceでフルスクリーン表示されます。スワイプで戻れます。クラシックモードと自動フルスクリーンを有効にします。ホットキーとEscapeは引き続き使用できます。",
            .showInDockTitle: "Dockに表示",
            .showInDockDescription: "LaunchNextをDockとCmd+Tab切り替えに表示します。",
        ...
        builder[.korean]?.merge([
            ...
            .kioskModeDescription: "홈 화면 모드. 앱이 각자의 Space에서 전체 화면으로 열립니다. 스와이프하여 돌아올 수 있습니다. 클래식 모드와 자동 전체 화면을 활성화합니다. 단축키와 Escape는 계속 작동합니다.",
            .showInDockTitle: "Dock에 표시",
            .showInDockDescription: "Dock과 Cmd+Tab 전환기에 LaunchNext를 표시합니다.",
        ...
        builder[.vietnamese]?.merge([
            ...
            .kioskModeDescription: "Che do man hinh chinh. Ung dung mo toan man hinh trong Space rieng — vuot de quay lai. Bat che do Co dien va Toan man hinh tu dong. Phim Escape va phim tat van hoat dong.",
            .showInDockTitle: "Hien thi tren Dock",
            .showInDockDescription: "Hien thi LaunchNext tren Dock va trinh chuyen doi Cmd+Tab.",
        ...
        builder[.french]?.merge([
            ...
            .kioskModeDescription: "Mode ecran d’accueil. Les apps s’ouvrent en plein ecran dans leur propre Space — balayez pour revenir. Active le mode Classique et le Plein ecran automatique. Echap et le raccourci fonctionnent toujours.",
            .showInDockTitle: "Afficher dans le Dock",
            .showInDockDescription: "Afficher LaunchNext dans le Dock et le selecteur Cmd+Tab.",
        ...
        builder[.spanish]?.merge([
            ...
            .kioskModeDescription: "Modo pantalla de inicio. Las apps se abren en pantalla completa en su propio Space — desliza para volver. Activa el modo Clasico y Pantalla completa automatica. Escape y el atajo siguen funcionando.",
            .showInDockTitle: "Mostrar en el Dock",
            .showInDockDescription: "Mostrar LaunchNext en el Dock y en el selector Cmd+Tab.",
            .settingsSectionGeneral: "General",
        ...
        builder[.czech]?.merge([
            ...
            .kioskModeDescription: "Rezim domovske obrazovky. Aplikace se otevrou na cely displej ve vlastnim Space — pretazenim se vratte. Aktivuje klasicky rezim a automaticky celou obrazovku. Escape a zkratka stale funguji.",
            .showInDockTitle: "Zobrazit v Docku",
            .showInDockDescription: "Zobrazit LaunchNext v Docku a prepinaci Cmd+Tab.",
        ...
        builder[.german]?.merge([
            ...
            .kioskModeDescription: "Startbildschirm-Modus. Apps offnen im Vollbild in einem eigenen Space — wischen zum Zuruckkehren. Aktiviert den klassischen Modus und automatischen Vollbildmodus. Escape und Tastenkurzel funktionieren weiterhin.",
            .showInDockTitle: "Im Dock anzeigen",
            .showInDockDescription: "LaunchNext im Dock und im Cmd+Tab-Umschalter anzeigen.",
        ...
        builder[.russian]?.merge([
            ...
            .kioskModeDescription: "Режим домашнего экрана. Приложения открываются в полноэкранном режиме в своём Space — смахните, чтобы вернуться. Включает классический режим и автополноэкранный режим. Escape и горячая клавиша по-прежнему работают.",
            .showInDockTitle: "Показать в Dock",
            .showInDockDescription: "Показывать LaunchNext в Dock и переключателе Cmd+Tab.",
        ...
        hindiDictionary.merge([
            ...
            .kioskModeDescription: "होम स्क्रीन मोड। ऐप्स अपने Space में फ़ुल स्क्रीन में खुलते हैं — वापस लौटने के लिए स्वाइप करें। क्लासिक मोड और ऑटो फ़ुल स्क्रीन सक्रिय करता है। हॉटकी और Escape अभी भी काम करती हैं।",
            .showInDockTitle: "Dock में दिखाएँ",
            .showInDockDescription: "LaunchNext को Dock और Cmd+Tab स्विचर में दिखाएँ।",
